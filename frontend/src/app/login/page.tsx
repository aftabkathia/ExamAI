  ...
  return (
    <div className="mx-auto flex max-w-md flex-col justify-center py-8 animate-fade-up">
      <div className="text-center">
        ...
        <h1 className="mt-3 font-display text-4xl text-sand-50">Log in</h1>
        <p className="mt-2 text-sand-200/60">Continue your adaptive practice streak.</p>
      </div>
      ...
      <p className="mt-6 text-center text-sm text-sand-200/55">
        New here?{" "}
        <Link href="/register" className="text-jade-400 hover:underline">
          Create an account
        </Link>
      </p>
    </div>
